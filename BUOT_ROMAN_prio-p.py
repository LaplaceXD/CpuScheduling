...
# Activity: CPU Scheduling Algorithm: Priority Preemptive
# ===========================================================
...
def main():
    ...
    print("Priority Preemptive - Simulator")
    ...
    oss = OS(Priority, process_list)
    oss.run()

    # ===== METRICS SUMMARY =====
    os.system("cls")
    print("===== PRIORITY PREEMPTIVE - CPU SCHEDULING =====")
    print("# PROCESS TABLE")
