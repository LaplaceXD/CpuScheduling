...
# Activity: CPU Scheduling Algorithm: Shortest Remaining Time First
# ===========================================================
...
def main():
    ...
    print("Shortest Remaining Time First - Simulator")
    ...
    oss = OS(SRTF, process_list)
    oss.run()

    # ===== METRICS SUMMARY =====
    os.system("cls")
    print("===== SHORTEST REMAINING TIME FIRST (SRTF) - CPU SCHEDULING =====")
    print("# PROCESS TABLE")
